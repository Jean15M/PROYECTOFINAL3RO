...
public class controlador_Mod_Usuario {
    ...
    public void cargarCliente(){
        ...
        if(modeloCliente.cargarCliente().isEmpty()){
          JOptionPane.showMessageDialog(null, "El cliente no se encuentra en la base de datos");
           ...
           vistaMod.getTxtcedula().setText(p.getCedulaCliente());
           vistaMod.getTxtnom1().setText(p.getNombrePersona1());
           vistaMod.getTxtnom2().setText(p.getNombrePersona1());
           vistaMod.getTxtape1().setText(p.getApellidoPersona1());
           });
        }
    }
    ...
    private void modificarUsuario() {
        ...
        if (vistaMod.getTxtcedula().getText().isEmpty() || vistaMod.getTxtnom1().getText().isEmpty() || vistaMod.getTxtnom2().getText().isEmpty() || vistaMod.getTxtape1().getText().isEmpty() || vistaMod.getTxtape2().getText().isEmpty() || vistaMod.getTxtcorreo().getText().isEmpty() || vistaMod.getTxttelefono().getText().isEmpty() || vistaMod.getTxtcontrasena().getText().isEmpty() || vistaMod.getTxtdireccion().getText().isEmpty() || vistaMod.getTxtUsuario().getText().isEmpty() || vistaMod.getComgenero().getSelectedIndex() == 0 || vistaMod.getComcanto().getSelectedIndex() == 0 || vistaMod.getComprovin().getSelectedIndex() == 0) {
            ...
            if (!Validaciones.NombreValido(vistaMod.getTxtnom1().getText()) || !Validaciones.NombreValido(vistaMod.getTxtnom2().getText())) {
                ...
                per1.setGeneroPersona(vistaMod.getComgenero().getSelectedItem().toString());
                ...
                canton.setNombreCan(vistaMod.getComcanto().getSelectedItem().toString());
                ...
                if (per1.grabarPersona() == true) {
                    if (modeloCliente.grabarCliente()) {
                        JOptionPane.showMessageDialog(null, "MODIFICADO EXITOSAMENTE");
                        vistaMod.dispose();
                    } else {
                        per1.eliminarPersona();
                        modeloCliente.eliminarCliente();
